...
export function TraderInfo(props: ContentProps) {
  return (
    <div>
      ...
      <div className="ml-[15%] mr-8">
        ...
        <div className="mb-5 text-center text-5xl font-bold">Trader Dashboard</div>
          <div className="py-4">
              ...
              <table className="w-full leading-normal">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border-b border-gray-200 bg-white p-5 text-sm">
                      <p className="whitespace-nowrap text-gray-900">test1@test.com</p>
                    </td>
                    <td className="border-b border-gray-200 bg-white p-5 text-sm">
                      <p className="whitespace-nowrap text-gray-900">
                        5/10/2023
                  ...
                  <tr>
                    ...
                    <td className="border-b border-gray-200 bg-white p-5 text-sm">
                      <p className="whitespace-nowrap text-gray-900">xyz@test.com</p>
                    </td>
                    <td className="border-b border-gray-200 bg-white p-5 text-sm">
                      <p className="whitespace-nowrap text-gray-900">
                        06/10/2023
